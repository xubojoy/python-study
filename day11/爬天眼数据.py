...
def driver_open():
    ...
    chromedriver = "/Users/xubojoy/Documents/chromedriver"
...
if __name__=='__main__':
    ...
    print ('----获取基础信息----',get_basic_info(soup))
    print ('----获取高管信息----',get_gg_info(soup))
    print ('----获取股东信息----',get_gd_info(soup))
    print ('----获取对外投资信息----',get_tz_info(soup))